...
static void post_restore_defaults(void)
{
#if defined(PLAX56_XP4) || defined(RT360V6) || defined(RTAX18)
...
#if defined(RTCONFIG_WANPORT2) || defined(PLAX56_XP4) || defined(RT360V6) || defined(RTAX18)
...
void BT_chip_reset(int stage)
{
	...
	bt_reset = 34;
        ...
        bt_reset = 29;
#elif defined(PLAX56_XP4) || defined(RT360V6) || defined(RTAX18)
        bt_reset = 79;
